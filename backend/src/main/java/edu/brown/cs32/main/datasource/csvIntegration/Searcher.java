...
public class Searcher {
   ...
   */
  public Searcher(Parser<List<String>> toParse)
  ...
  public Searcher(Parser<List<String>> parser, String toSearch, ColumnIdentifier whichIdentifier, String columnIdentifier) {
  }
   ...
   */
  public ArrayList<List<String>> searchByHeaderName(
      String headerName, String toSearch)
    ...
    else {return this.searchByIndex(indexToSearch, toSearch);}
  }
   ...
   * @return an ArrayList representing results of the search, empty if no results found
   */
  public ArrayList<List<String>> searchByIndex(
      Integer index, String toSearch) throws InvalidColumnIdentifierValueException {
