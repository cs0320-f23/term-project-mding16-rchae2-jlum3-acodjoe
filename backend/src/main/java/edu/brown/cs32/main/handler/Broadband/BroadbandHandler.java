package edu.brown.cs32.main.handler.Broadband;
...
public class BroadbandHandler implements Route {
  ...
  public Object handle(Request request, Response response) throws Exception {
    try{
      ...
      return new BroadbandHandler.ErrorResponse("error_bad_request: " + e.getMessage()).serialize();
    }
  }
  ...
  public record SuccessResponse(String result,Map<String, Object> data){
    ...
    String serialize() {
      ...
      return moshi.adapter(BroadbandHandler.SuccessResponse.class).toJson(this);
    }
  }
  ...
  public record ErrorResponse(String result) {
    String serialize() {
      Moshi moshi = new Moshi.Builder().build();
      return moshi.adapter(BroadbandHandler.ErrorResponse.class).toJson(this);
    }
  }
}
