package edu.brown.cs32.main.handler.Helpers;
...
public class RequestHelper {
  ...
  /** This is the constructor for RequestHelper class which initializes request
   * and requiredParams
   *
   * @param request
  ...
  public Map<String, String> getUsefulRequestParams() throws MissingArgumentException{
    ...
    for (String s : this.requiredParams){
      ...
      else {throw new MissingArgumentException(s);}
    }
    return usefulParams;
  }
